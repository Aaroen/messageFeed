...
import AppReaderDetailOutlet from '@/components/AppReaderDetailOutlet.vue'
import AppReaderSourceOutlet from '@/components/AppReaderSourceOutlet.vue'
...
<template>
  <ReaderStack
    ...
    :detail-interactive="detailInteractive"
  ...
  >
    <template #source>
      <AppReaderSourceOutlet
        ...
        :source-pull-refreshing="sourcePullRefreshing"
        ...
        :source-background-refresh="sourceBackgroundRefresh"
    ...
    <template #detail>
      <AppReaderDetailOutlet
        ...
        :detail-morph-meta-style="detailMorphMetaStyle"
        :detail-morph-title-style="detailMorphTitleStyle"
        :detail-morph-summary-style="detailMorphSummaryStyle"
        ...
        :detail-inline-meta-style="detailInlineMetaStyle"
        :detail-frame-style="detailFrameStyle"
        :detail-actions-style="detailActionsStyle"
